...
create table Member(
	...
	residentNumber varchar(200) not null COMMENT '주민번호',
    ...
    adminCheck char(1) not null COMMENT '관리자 여부 (1: 일반 회원, 2: 관리자)'
...
create table Board(
    ...
    regdate datetime DEFAULT now() COMMENT '등록날짜',
...
CREATE TABLE CarFavorites (
    ...
    CONSTRAINT fk_carmain_c_idx FOREIGN KEY (c_idx) REFERENCES CarMain(c_idx)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
