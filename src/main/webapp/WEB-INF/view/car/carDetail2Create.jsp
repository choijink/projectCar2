...
<body>
	...
	<section>
		<div style="text-align: center; margin-top: 60px;">
			<span class="col">차량 : </span> <select id="carNameSelect" onchange="carNameSelected()"></select>
		</div>
	</section>
	<section class="ftco-section ftco-car-details">
		...
		<div class="table-container">
			...
			<table>
			 ...
			 <tr> 
			 <td>가격</td> 
			 <td><input type="text" id="priceInput" class="centered-input" placeholder="9,590만원"></td>
			 </tr> 
			 </tbody> 
			</table>
		</div>
...
<script>
	...
	function carNameSelected(){
		var cIdx = document.getElementById('carNameSelect').value;
		$.ajax({
